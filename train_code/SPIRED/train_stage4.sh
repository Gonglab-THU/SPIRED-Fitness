...
valid_coords_seq_hdf5="./data/PDB_2022_05-2023_05.h5"
SPIRED_saved_model="output_stage3/SPIRED_Model_Para_epoch60.pth"

mkdir $outdir
CUDA_VISIBLE_DEVICES=0,1,2 python -u scripts/train_SPIRED_stage3.py \
		--SPIRED_saved_model $SPIRED_saved_model \
		--epoch_start 60 --epoch_end 90 \
        --batch 64 --maxlen 350 \
        --lr_start 0.00005 --lr_end 0.00005 \
        ...
        --valid_length 600 \
		--out_dir $outdir --gpu_SPIRED 0 1 2 --gpu_esm 0
echo end `date`
